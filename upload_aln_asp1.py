...
def create_and_parse_argument_options(argument_list):
    ...
    parser.add_argument('-aln_method','--alignment_method', help='Alignment method used (default: GSD_LSD_rRNA)', type=str, default='PRAGUE')
    parser.add_argument('-host','--db_host', help='Defines database host (default: 130.207.36.76)', type=str, default='130.207.36.76')
    parser.add_argument('-schema','--db_schema', help='Defines schema to use (default: DESIRE)', type=str, default='DESIRE_HV1')
    parser.add_argument('-user_name','--uname', help='Defines user name to use (default: anton)', type=str, default='harshiniv')
