...
var __awaiter = this && this.__awaiter || function (t, s, a, h) {
    ...
    RdPu = window.RdPu,
    YlGn = window.YlGn,
    mapped_aa_properties = window.mapped_aa_properties,
    ...
    PdbTopologyViewerPlugin = function () {
        function t() {
            this.defaultColours = {
                ...
                if (void 0 === this.domainTypes && (this.domainTypes = [{
                        label: "Select data",
                        data: null
                    }], this.getAnnotationFromRibovision(mapped_aa_properties), this.selectedDomain = this.domainTypes[0]), 1 < this.domainTypes.length) {
                    var i = "";
        ...
        return t.prototype.render = function (t, e) {
            ...
            if (t.forEach(function (t, e) {
                ...
                }), t.size < mapped_aa_properties.get("Charge").length)
                for (var e = t.size - 1; e < mapped_aa_properties.get("Charge").length; e++) selectSections_RV1.get(r).push({
                    entity_id: u.entityId,
                    start_residue_number: e,
                    end_residue_number: e,
                    color: {
            ...
            t && t.forEach(function (t, e) {
                ...
                var o = Math.min.apply(Math, aaPropertyConstants.get(n)),
                    s = Math.max.apply(Math, aaPropertyConstants.get(n)),
                    a = aaColorData.get(n),
